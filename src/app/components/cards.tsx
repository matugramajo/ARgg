...
const Cards: React.FC = () => {
  return (
    <div className="text-white grid grid-cols-1 md:grid-cols-2 gap-10 md:flex-row justify-between mx-6 md:mx-24 mt-3 md:mt-7 text-lg">
      <div className="basis-1/2">
        <div className="pb-3 bg-[#151426]">Proximos partidos</div>
        <div className="grid grid-cols-1 bg-[#232240] text-[#a1a1a1] border border-[#9199E1] rounded-lg ">
      ...
      <div className="basis-1/2 mt-8 md:mt-0">
        <div className="pb-3">Equipos mas visitados</div>
        <div className="grid grid-cols-2 gap-2 md:grid-cols-3 md:gap-5 border rounded-lg bg-[#232240] border-[#9199E1]">
